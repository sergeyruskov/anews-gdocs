/* global React */
import { loadSites, getAuthUrl, surroundSelectionText, deleteSite, refreshSite } from './services';
...
export default class App extends React.Component {
	constructor( props ) {
		...
		this.surroundSelectionText = this.surroundSelectionText.bind( this )
	...
	render() {
		...
		return <div className="container">
			<h1 onClick={() => surroundSelectionText()} className="button">Цитата</h1>
